...
function DeliveredOrdersTableItems({order}) {
  ...
  return (
    <>
      <tr className="h-[10vh] text-xs">
        ...
        <td className="pl-14 py-2 text-xs text-gray-600 text-left">
          {order && (order.isDelivered && order.isConfirmed && order.isLaunched) ? (
            <>Delivered</>
          ) : (
            <p className="text-xs font-bold text-pink-500">Not Delivered</p>
          )}
        </td>
...
export default DeliveredOrdersTableItems;
